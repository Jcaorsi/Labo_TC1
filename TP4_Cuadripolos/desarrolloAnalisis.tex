...
de numero reales puros sugeriria de errores de medición, como ya se menciono en el apartado anterior de las matrices individuales.

\par Así, se considera que se obtuvieron buenos resultados para las conexiones en serie y en paralelo (a pesar del resultado del Test
de Brune en paralelo), pero no para la conexión en cascada.
