...
Otro valor que fue estudiado a lo largo del tp ´

Un valor muy útil de referencia es el tiempo $\tau$. En particual al evaluar un sistema de primer orden con t=$\tau$, la exponencial llega al valor $e^{-1}$, esto lleva al valor de 63\% del valor inicial. No obstante, en el caso del sobreamortiguado, al tener dos exponenciales, se suele aproximar este valor al tomar solo el valor de la exponencial que decrece menos rápido y despreciando el otro valor.
...
\end{figure}
    ...
    \begin{enumerate}
        ...
        \item En esta parte, se ajustó la resistencia Rv a su valor máximo. Poteriormente, se coloco uno de los cursores horizontales del osciloscopio en $ V_{salida}=0$ V, y el otro en $ V_{salida}=3,16$ V y medimos el $ \Delta t $ entre esos valores, tomandolo como el $\tau$ del sistema. Se tomo este valor de tension ya que es el que coincide con $V_{medido} = V_{fuente}(1-e^{-1})$. Con este valor aproximado, se midió la salida en el tiempo $ 5\tau$.
    ...
    \subsection{Mediciones}
        ...
        \subsubsection*{Capacitor de C = 47 pF}
            \begin{itemize}
                ...
                \item Tiempo en que la salida llegó a 4,982 V ($ 5V \pm 0,25V $) con las resistencias cortocircuitadas: $ t = 11 \mu s$ % item 5
            \end{itemize}
    ...
    \subsection{Cálculos}
        ...
        \subsubsection*{Resultados}
            ...
            \subsubsection*{Capacitor de C = 470 pF}
                ...
                Inductancia L (a partir de $R_{critico}$):
