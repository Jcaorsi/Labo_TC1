...
\begin{figure}[H]
   ...
   \begin{tikzpicture}
	...
	\draw (15.75, -14.5) to[american voltage source, l={$V_{fuente}$}, label distance=0.1cm] (15.75, -17.75);
	\draw (15.75, -14.5) to[american resistor, l={$R_{resistor}$}] (19.5, -14.5);
	\draw (19.5, -14.5) to[variable american resistor, l={$R_{V}$}] (22.25, -14.5);
	\draw (22.25, -14.5) to[cute inductor, l={$L$}] (22.25, -17.75);
	\draw (22.25, -17.75) to[capacitor, l={$C$}] (15.75, -17.75);
	\node[shape=rectangle, minimum width=2.75cm, minimum height=0.5cm] at (19.25, -17){} node[anchor=north, align=center, text width=2.397cm, inner sep=5pt] at (19.25, -16.75){-  $Vs_{salida}$  +};
\end{tikzpicture}
