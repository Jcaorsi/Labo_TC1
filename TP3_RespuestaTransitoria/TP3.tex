...
\begin{figure}[H]
   ...
   \begin{tikzpicture}
	...
	\node[shape=rectangle, minimum width=2.75cm, minimum height=0.5cm] at (19.25, -17){} node[anchor=north, align=center, text width=2.397cm, inner sep=5pt] at (19.25, -16.75){-  $V_{salida}$  +};
\end{tikzpicture}
